...
# GTest and GMock
#
if [ ! -f "$TWS_DIR/lib/libgmock.a" ]; then
...
cp libgtest.a $TWS_DIR/lib/
valid $? "Error: could not copy libgtest.a!"

cp libgtest_main.a $TWS_DIR/lib/
valid $? "Error: could not copy libgtest_main.a!"

cp -r include/gtest/ $TWS_DIR/include/
...
cp libgmock.a $TWS_DIR/lib/
valid $? "Error: could not copy libgmock.a!"

cp libgmock_main.a $TWS_DIR/lib/
valid $? "Error: could not copy libgmock_main.a!"

cp -r include/gmock $TWS_DIR/include/
valid $? "Error: could not copy include dir!"
